...
| --- | --- | --- | --- |
| [mattpocock/skills](https://github.com/mattpocock/skills) | 벤더 (스킬별 VENDOR.md) | `agents/skills/`: active 29종 (2026-08-06 갱신, v1.2.2/8b36d4f 기준. 신규 wizard, to-questionnaire, wait-what, rename writing-great-skills→writing-for-agents) + upstream 삭제 2종 로컬 보존(edit-article, obsidian-vault) | 시험 기간 (CLAUDE.md 규약) |
