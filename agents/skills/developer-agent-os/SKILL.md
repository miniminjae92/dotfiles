...
- For T1/T2, create a Run from `/Users/miniminjae/.obsidian/mimir/_System/Templates/Run.md` under `40 Reviews/Runs/`. Keep the template's `status: archived`: run logs are terminal records, never promotion candidates.
